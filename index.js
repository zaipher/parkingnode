...
const replaceTemplate = (temp, product) => {
    let output = temp.replace(/{%PARKINGNAME%}/g, product.productName);
    output = output.replace(/{%PARKINGIMG%}/g, product.image);
